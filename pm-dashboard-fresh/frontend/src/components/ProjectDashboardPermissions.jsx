...
const getProjectAccessLevel = (project, currentUserId, currentUserRole) => {
  ...
  if (currentUserRole === 'Executive Leader') {
    return {
      ...
      canEdit: false,          // âŒ Executive Leaders are read-only
      canDelete: false,        // âŒ Executive Leaders are read-only
      canManageTeam: false,    // âŒ Executive Leaders cannot manage project teams
      canComment: true,        // âœ… Executive Leaders can comment
      canView: true           // âœ… Executive Leaders can view all projects
    };
  }
